...
class GlobalSettingData {
  GlobalSettingData({
    ...
    String? sslcommerzStorePasswd,
    String? sslcommerzCurrencyCode,
    num? enableChatbot,
    String? chatbotThumb,
    String? chatbotName,
    String? chatgptToken,
    ...
    _sslcommerzStoreId = sslcommerzStoreId;
    _sslcommerzStorePasswd = sslcommerzStorePasswd;
    _sslcommerzCurrencyCode = sslcommerzCurrencyCode;
    _enableChatbot = enableChatbot;
    _chatbotThumb = chatbotThumb;
  ...
  GlobalSettingData.fromJson(dynamic json) {
    ...
    _sslcommerzStoreId = json['sslcommerz_store_id'];
    _sslcommerzStorePasswd = json['sslcommerz_store_passwd'];
    _sslcommerzCurrencyCode = json['sslcommerz_currency_code'];
    _enableChatbot = json['enable_chatbot'];
    _chatbotThumb = json['chatbot_thumb'];
    _chatbotName = json['chatbot_name'];
    _chatgptToken = json['chatgpt_token'];
    _createdAt = json['created_at'];
    _updatedAt = json['updated_at'];
    if (json['reminders'] != null) {
      _reminders = [];
      json['reminders'].forEach((v) {
        _reminders?.add(Reminders.fromJson(v));
      });
    }
    if (json['taxes'] != null) {
      _taxes = [];
  ...
  String? _sslcommerzStoreId;
  String? _sslcommerzStorePasswd;
  String? _sslcommerzCurrencyCode;
  num? _enableChatbot;
  String? _chatbotThumb;
  String? _chatbotName;
  ...
  String? get sslcommerzStoreId => _sslcommerzStoreId;

  String? get sslcommerzStorePasswd => _sslcommerzStorePasswd;

  String? get sslcommerzCurrencyCode => _sslcommerzCurrencyCode;

  num? get enableChatbot => _enableChatbot;

  String? get chatbotThumb => _chatbotThumb;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['sslcommerz_store_id'] = _sslcommerzStoreId;
    map['sslcommerz_store_passwd'] = _sslcommerzStorePasswd;
    map['sslcommerz_currency_code'] = _sslcommerzCurrencyCode;
    map['enable_chatbot'] = _enableChatbot;
    map['chatbot_thumb'] = _chatbotThumb;
    map['chatbot_name'] = _chatbotName;
    map['chatgpt_token'] = _chatgptToken;
    map['created_at'] = _createdAt;
    map['updated_at'] = _updatedAt;
    if (_reminders != null) {
      map['reminders'] = _reminders?.map((v) => v.toJson()).toList();
    }
    if (_taxes != null) {
