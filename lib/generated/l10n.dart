...
class S {
  ...
  /// `Flash Care`
  String get appName {
    return Intl.message('Flash Care', name: 'appName', desc: '', args: []);
  }
  ...
  String get suggestUs {
    return Intl.message('Suggest Us', name: 'suggestUs', desc: '', args: []);
  }
  ...
  /// `At Clinic`
  String get atClinic {
    return Intl.message('At Clinic', name: 'atClinic', desc: '', args: []);
  }
  ...
  /// `June`
  String get jun {
    return Intl.message('June', name: 'jun', desc: '', args: []);
  }

  /// `July`
  String get jul {
    return Intl.message('July', name: 'jul', desc: '', args: []);
  }
  ...
  /// `Sept`
  String get sep {
    return Intl.message('Sept', name: 'sep', desc: '', args: []);
  }
  ...
  /// `Payouts`
  String get payouts {
    return Intl.message('Payouts', name: 'payouts', desc: '', args: []);
  }
  ...
  String get helpAndFAQs {
    return Intl.message('Help & FAQs', name: 'helpAndFAQs', desc: '', args: []);
  }
  ...
  /// `Earning`
  String get earning {
    return Intl.message('Earning', name: 'earning', desc: '', args: []);
  }
  ...
  String get totalUnits {
    return Intl.message('Total Units', name: 'totalUnits', desc: '', args: []);
  }

  /// `Extra Notes`
  String get extraNotes {
    return Intl.message('Extra Notes', name: 'extraNotes', desc: '', args: []);
  }
  ...
  /// `QR Scan`
  String get qRScan {
    return Intl.message('QR Scan', name: 'qRScan', desc: '', args: []);
  }
  ...
  String get slotLimit {
    return Intl.message('Slot limit', name: 'slotLimit', desc: '', args: []);
  }
  ...
  /// `Add Slot`
  String get addSlot {
    return Intl.message('Add Slot', name: 'addSlot', desc: '', args: []);
  }
  ...
  String get deleteSlot {
    return Intl.message('Delete Slot', name: 'deleteSlot', desc: '', args: []);
  }
  ...
  String get myCategory {
    return Intl.message('My Category', name: 'myCategory', desc: '', args: []);
  }
  ...
  /// `No Review`
  String get noReview {
    return Intl.message('No Review', name: 'noReview', desc: '', args: []);
  }

  /// `No Award`
  String get noAward {
    return Intl.message('No Award', name: 'noAward', desc: '', args: []);
  }
