...
import 'package:patient_flutter/firebase_options.dart';
...
Future<void> _firebaseMessagingBackgroundHandler(RemoteMessage message) async {
  debugPrint(
      '🐦‍🔥🐦‍🔥🐦‍🔥🐦‍🔥 MessagingBackgroundHandler : ${message.toMap()}');
  try {
...
Future<void> main() async {
  ...
  SessionManager.instance.setString(key: kLanguage, value: appLanguageCode);
