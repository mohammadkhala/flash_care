...
class PreviousAppointmentScreen extends StatelessWidget {
  ...
  const PreviousAppointmentScreen({super.key, this.appointmentData});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          TopBarArea(title: S.current.previousAppointments),
            ...
            child: appointmentData?.previousAppointments == null ||
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      AppointmentData? previousAppointment =
                          ...
                          children: [
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    previousAppointment?.appointmentNumber ??
                                        '',
                                  ...
                                  const SizedBox(height: 5),
                                  Text(
                                    '${(previousAppointment?.date ?? '').appointmentDate} ${(previousAppointment?.time ?? '').appointmentTime}',
                                    style: const TextStyle(
                                      fontSize: 14,
