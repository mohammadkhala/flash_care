...
class CenterAreaChat extends StatelessWidget {
  ...
  const CenterAreaChat({super.key,
        ...
        child: ScrollConfiguration(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              // Compare as strings to avoid int/double type coercion issues on Flutter Web
              final bool isMine = data.senderUser?.userId?.toString() ==
                  doctorData?.id?.toString();
              return isMine
                  ? _yourMsg(data, onJoinMeeting)
                  : _otherMsg(data, onJoinMeeting);
            },
          ),
        ),
      ),
        ...
        data.msgType == FirebaseRes.text
            ...
            : data.msgType == FirebaseRes.image
                ? ChatImageCard(
                    ...
                    margin: EdgeInsets.only(right: Get.width / 2.3),
