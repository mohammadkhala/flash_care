...
/// Full-screen Agora RTC call screen.
...
class _CallScreenState extends State<CallScreen> {
  ...
  Future<void> _init() async {
    ...
    // 2. Fetch token (failure is non-fatal — join with empty token)
    try {
  ...
  Widget _buildWaitingOverlay() => Container(
    color: const Color(0xFF0A1628),
    child: Center(
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        const CircularProgressIndicator(color: AppColors.primary, strokeWidth: 2),
        const SizedBox(height: 16),
        Text('في انتظار ${widget.partnerName}...',
      ...
      child: Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          OutlinedButton.icon(
            ...
            label: const Text('رجوع', style: TextStyle(color: Colors.white38)),
            style: OutlinedButton.styleFrom(
      ...
      child: Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          OutlinedButton.icon(
            ...
            label: const Text('رجوع', style: TextStyle(color: Colors.white70)),
            style: OutlinedButton.styleFrom(
              side: const BorderSide(color: Colors.white24),
              minimumSize: const Size(220, 48),
              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(14)),
